...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About D' Valley's Arena — Multi-Concept Lifestyle Destination in Bori, Rivers State" },
      { name: "description", content: "D' Valley's Arena is Bori's premier lifestyle destination built around five pillars: hospitality, entertainment, platinum fitness, velvet nightclub, and lounge. Located at No. 3 Pius Akere Street, Bori, Rivers State." },
      { name: "keywords", content: "about D Valley's Arena, lifestyle destination Bori, entertainment venue Rivers State, nightclub Bori, lounge Bori Rivers State" },
      { property: "og:title", content: "About D' Valley's Arena — More Than a Venue. A Global Family." },
      { property: "og:description", content: "D' Valley's Arena is a premier multi-concept lifestyle destination built around five pillars: hospitality, entertainment, fitness, nightlife and lounge." },
