...
const whiteSoupImg = { url: "/goat-meat-soup.jpg" };
  ...
  },
  {
    ...
    categories: [
      ...
      },
      {
        name: "Cocktails",
        items: [
          { name: "Long Island Iced Tea", price: "10,000", img: "/long-island-ice-tea.png", alt: "Long Island Iced Tea in tall glass with lemon" },
          { name: "Strawberry Daiquiri", price: "9,000", img: "/strawberry-daiquiri.jpg", alt: "Frozen strawberry daiquiri cocktail" },
          { name: "Tequila Sunrise", price: "9,000", img: "/tequila-sunrise.jpg", alt: "Tequila Sunrise with orange and grenadine" },
          { name: "Pina Colada", price: "9,000", img: "/pina-colada.jpg", alt: "Pina Colada in coconut glass with pineapple" },
        ],
      },
      {
        name: "Mocktails",
        items: [
          { name: "Virgin Mojito", price: "8,000", img: "/virgin-mojito.jpeg", alt: "Virgin mojito with lime and fresh mint" },
          { name: "Virgin Pina Colada", price: "8,000", img: "/virgin-pina-colada.jpg", alt: "Non-alcoholic pina colada mocktail" },
          { name: "Shirley Temple", price: "8,000", img: "/shirley-temple.png", alt: "Shirley Temple mocktail with cherry" },
          { name: "Sweet Sunrise", price: "8,000", img: "/sweet-sunrise.png", alt: "Sweet sunrise mocktail with grenadine" },
        ],
      },
      {
        name: "Barman's Specials",
        items: [
          { name: "BIGTEE Sea-breeze", price: "10,000", img: "/bigtee-sea-breeze.png", alt: "Signature sea-breeze cocktail" },
          { name: "Old Fashioned", price: "9,000", img: "/old-fashioned-cocktail.jpg", alt: "Classic Old Fashioned whiskey cocktail" },
          { name: "Cosmopolitan", price: "9,000", img: "/cosmopolitan.png", alt: "Cosmopolitan cocktail in martini glass" },
          { name: "Electric Cocktail", price: "10,000", img: "/electric-cocktail.jpg", alt: "Electric-blue signature cocktail" },
        ],
      },
    ],
  },
