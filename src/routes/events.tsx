...
const festival = { url: "/lounge.jpg" };
const nightlife = { url: "/nightlife.jpg" };
const turf = { url: "/turf.png" };
const gym = { url: "/gym.png" };
const sipPaint = { url: "/sip-paint.png" };
const clubLogo = { url: "/club-logo-clean.png" };
const heroVideo = { url: "/events-hero.mp4" };
export const Route = createFileRoute("/events")({
  head: () => ({
    meta: [
      { title: "Events & Weekly Lifestyle Programme — D' Valley's Arena Bori, Rivers State" },
      { name: "description", content: "Ladies' Nights every Wednesday, Bottle Tuesday, fitness challenges, Sip & Paint evenings, arena turf football, and VIP nightlife at D' Valley's Arena, Bori, Rivers State." },
      { name: "keywords", content: "events Bori Rivers State, ladies night Bori, nightlife Bori, Sip and Paint Rivers State, arena turf Bori, D Valley's Arena events" },
      { property: "og:title", content: "Events & Weekly Lifestyle Programme — D' Valley's Arena" },
      { property: "og:description", content: "High-energy nights, fitness challenges, Sip & Paint, arena turf football and VIP nightlife every week in Bori, Rivers State." },
      ...
      <section className="section-dark py-24 md:py-32 border-t border-border">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center text-center mb-16">
            <img
              src={clubLogo.url}
              alt="D' Valley's Club nightlife logo"
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div className="relative aspect-[4/5] overflow-hidden rounded-sm border border-amber-glow/40">
              <img src={nightlife.url} alt="VIP bottle service at D' Valley's Club Bori" className="absolute inset-0 w-full h-full object-cover" />
