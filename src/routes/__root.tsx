...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "D' Valley's Arena — Where Great Taste Meets Precious Moments" },
      { name: "description", content: "Premier multi-concept lifestyle destination: hospitality, entertainment, fitness, nightlife and lounge. For global trendsetters." },
      { name: "theme-color", content: "#0a0a0a" },
      { property: "og:site_name", content: "D' Valley's Arena" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "D' Valley's Arena" },
      { property: "og:description", content: "Where great taste meets precious moments together." },
